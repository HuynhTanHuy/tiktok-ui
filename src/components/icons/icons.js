export const Telegram = ({ width = '2.6rem', height = '2.6rem', className }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const Home = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        class={className}
        width={width}
        data-e2e=""
...
export const HomeActive = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        class={className}
        width={width}
        data-e2e=""
...
export const Explore = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        fill="currentColor"
        class={className}
        width={width}
...
export const ExploreActive = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        fill="rgba(254, 44, 85, 1)"
        class={className}
        width={width}
...
export const Follow = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        fill="currentColor"
        class={className}
        width={width}
...
export const FollowActive = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" class={className} width={width} height={height} fill="rgba(254, 44, 85, 1)">
...
export const People = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        class={className}
        width={width}
        data-e2e=""
...
export const PeopleActive = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        class={className}
        width={width}
        data-e2e=""
...
export const Live = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        class={className}
        width={width}
        data-e2e=""
...
export const LiveActive = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        class={className}
        width={width}
        data-e2e=""
